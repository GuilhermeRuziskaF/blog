...
@section('description', 'Descrição da página Postagem siples')
@section('titulo', 'Postagem simples')
                    ...
                    <div class="col-md-9 post-content" data-aos="fade-up">
                        ...
                        <div class="comments">
                            ...
                            <div class="comment d-flex mb-4">
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-sm rounded-circle">
                                        <img class="avatar-img" src="{{ asset('blog/assets/img/person-5.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-2 ms-sm-3">
                                    ...
                                    <div class="comment-replies bg-light p-3 mt-3 rounded">
                                        ...
                                        <div class="reply d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <div class="avatar avatar-sm rounded-circle">
                                                    <img class="avatar-img" src="{{ asset('blog/assets/img/person-4.jpg') }}" alt=""
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ms-sm-3">
                                        ...
                                        <div class="reply d-flex">
                                            <div class="flex-shrink-0">
                                                <div class="avatar avatar-sm rounded-circle">
                                                    <img class="avatar-img" src="{{ asset('blog/assets/img/person-3.jpg') }}" alt=""
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-2 ms-sm-3">
                            ...
                            <div class="comment d-flex">
                                <div class="flex-shrink-0">
                                    <div class="avatar avatar-sm rounded-circle">
                                        <img class="avatar-img" src="{{ asset('blog/assets/img/person-2.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
