...
@section('description', 'Descrição da página de resultados')
@section('titulo', 'Página de resultados')
...
@section('conteudo')
    ...
    <section id="search-result" class="search-result">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <h3 class="category-title">Resultados da pesquisa:</h3>

                    <div class="d-md-flex post-entry-2 small-img">
                        <a href="{{route("blog.post")}}" class="me-4 thumbnail">
                        ...
                        <div>
                            ...
                            <h3><a href="{{route("blog.post")}}">What is the son of Football Coach John Gruden, Deuce Gruden doing
                                    Now?</a></h3>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('blog/assets/img/person-2.jpg') }}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            ...
                            <h3><a href="{{route("blog.post")}}">17 Pictures of Medium Length Hair in Layers That Will Inspire
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            ...
                            <h3><a href="{{route("blog.post")}}">The Best Homemade Masks for Face (keep the Pimples Away)</a></h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem
                                magni voluptates dolore. Tenetur fugiat voluptates quas.</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('blog/assets/img/person-2.jpg') }}" alt="" class="img-fluid">
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        ...
                        <div>
                            ...
                            <h3><a href="{{route("blog.post")}}">10 Life-Changing Hacks Every Working Mom Should Know</a></h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem
                                magni voluptates dolore. Tenetur fugiat voluptates quas.</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('blog/assets/img/person-2.jpg') }}" alt="" class="img-fluid">
                    ...
                    <div class="d-md-flex post-entry-2 small-img">
                        <a href="{{route("blog.post")}}" class="me-4 thumbnail">
                            <img src="{{ asset('blog/assets/img/post-landscape-4.jpg') }}" alt="" class="img-fluid">
                        </a>
                        <div>
                            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span>
                                <span>Jul 5th '22</span>
                            </div>
                            <h3><a href="{{route("blog.post")}}">9 Half-up/half-down Hairstyles for Long and Medium Hair</a></h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem
                                magni voluptates dolore. Tenetur fugiat voluptates quas.</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('blog/assets/img/person-2.jpg') }}" alt="" class="img-fluid">
                    ...
                    <div class="aside-block">
                        ...
                        <div class="video-post">
                            <a href="https://www.youtube.com/watch?v=AiFfDjmd0jU" class="glightbox link-video">
                                ...
                                <img src="{{ asset('blog/assets/img/post-landscape-5.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Video -->
