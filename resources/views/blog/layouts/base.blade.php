...
<head>
    ...
    <link href="{{ asset('blog/assets/css/variables.css') }}" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="{{route("blog.index")}}" class="logo d-flex align-items-center">
                <!-- Uncomment the line below if you also wish to use an image logo -->
                <!-- <img src="{{ asset('blog/assets/img/logo.png') }}" alt=""> -->
                <h1>Guilherme</h1>
            </a>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="{{route("blog.post")}}">Postagem Simples</a></li>

                    <li class="dropdown"><a href="{{route("blog.categorias")}}"><span>Categorias</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="{{route("blog.categorias")}}">Busca por Categoria</a></li>
                            <li><a href="{{route("blog.resultado")}}">Resultado de Pesquisa</a></li>
                        </ul>
                    </li>
            ...
            <div class="position-relative">
                ...
                <div class="search-form-wrap js-search-form-wrap">
                    <form action="{{route("blog.resultado")}}" class="search-form">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-6 col-lg-2">
                        ...
                        <ul class="footer-links list-unstyled">
                            ...
                            <li><a href="{{route("blog.post")}}"><i class="bi bi-chevron-right"></i> Single Post</a></li>
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="footer-links footer-blog-entry list-unstyled">
                            <li>
                                <a href="{{route("blog.post")}}" class="d-flex align-items-center">
                                    <img src="{{ asset('blog/assets/img/post-sq-1.jpg') }}" alt="" class="img-fluid me-3">
                                    <div>
                            ...
                            <li>
                                <a href="{{route("blog.post")}}" class="d-flex align-items-center">
                                    <img src="{{ asset('blog/assets/img/post-sq-2.jpg') }}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <li>
                                <a href="{{route("blog.post")}}" class="d-flex align-items-center">
                                    <img src="{{ asset('blog/assets/img/post-sq-3.jpg') }}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <li>
                                <a href="{{route("blog.post")}}" class="d-flex align-items-center">
                                    <img src="{{ asset('blog/assets/img/post-sq-4.jpg') }}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
